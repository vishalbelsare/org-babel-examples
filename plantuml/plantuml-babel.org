...
** Work Breakdown Structure (WBS)
   ...
   #+BEGIN_SRC plantuml :file fig/wbsdiag1org.png :exports both
     @startwbs
     scale 2
...
** gantt
   ...
   #+BEGIN_SRC plantuml :file fig/gantt1.png :exports both
     @startgantt
     scale 2
     saturday are closed
     sunday are closed
   ...
   #+BEGIN_SRC plantuml :file fig/gantt2.png :exports both
     @startgantt
     scale 2
     Projectscale weekly
     saturday are closed
...
** JSON
   ...
   #+BEGIN_SRC plantuml :file fig/jsondiag1.png :exports both
     @startjson
     scale 2
     {
        "fruit":"Apple",
   ...
   #+RESULTS:
   [[file:fig/jsondiag1.png]]


   #+BEGIN_SRC plantuml :file fig/jsondiag2.png :exports both
@startjson
scale 2
{
  "firstName": "John",
...
@endjson
   ...
   #+RESULTS:
   [[file:fig/jsondiag2.png]]
   

   Note: *the highlight style assignment will clash with the org mode noweb
   syntax*
   
   #+BEGIN_SRC plantuml :file fig/jsondiag3.png :exports both
@startjson
scale 2
<style>
  .h1 {
...
@endjson
   ...
   #+RESULTS:
   [[file:fig/jsondiag3.png]]

* Listing sprites
  #+BEGIN_SRC plantuml :file fig/listsprites1.png :exports both
    @startuml
    scale 2
