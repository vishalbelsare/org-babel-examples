...
#+DATE:      9. 04. 2026
# Can add institute information
#+BEAMER_HEADER: \institute{myInstitute}
#+DESCRIPTION: 
#+KEYWORDS: 
#+LANGUAGE:  en
...
# [10pt] : font size
#+LaTeX_CLASS_OPTIONS: [t,10pt,xcolor={dvipsnames},aspectratio=169]
...
# #+BEAMER_FONT_THEME:
# #+BEAMER_INNER_THEME:
# #+BEAMER_OUTER_THEME: smoothbars [subsection=false]
